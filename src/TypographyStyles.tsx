...
If we use 'em', then multiple applications of a mixin
will multiply together (e.g. 2em in parent, 2em in descendant
gets you 4em).

If we use 'px', then root scaling is ignored. So rem for
all the mixins, and individual adjustments at the tag level
should use 'em'.

For other sizes (margins, letter-spacing), we use em to be
relative to the _current_ font-size.
