...
export const RealizingAppreciationData = (url: string, title: string) => {
  const route = AcademyUrl + url;
  const backUrl = CoursesUrl + '/' + titleToUrlFragment(title);

  const realizingStartData = (
    <SlideContainer>
      <Box w="100%">
  ...
  const realizingAppreciationData = [
    (
      <SlideContainer key="Realizing-1">
        <Box>
    ...
    (
      <SlideContainer key="Realizing-2">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-3">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-4">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-5">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-6">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-7">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-8">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-9">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Realizing-10">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="9" nextStep="11" />
      </SlideContainer>
    ),
    (
      <SlideContainer key="Realizing-11">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="10" nextStep="back-to-property" />
      </SlideContainer>
    ),
  ];

  const realizingEndData = (
    <Box pb={40}>
