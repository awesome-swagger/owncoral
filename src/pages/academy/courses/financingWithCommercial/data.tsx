...
export const FinancingWithCommercialData = (url: string, title: string) => {
  const route = AcademyUrl + url;
  const backUrl = CoursesUrl + '/' + titleToUrlFragment(title);

  const financingStartData = (
    <SlideContainer>
      <Box w="100%">
  ...
  const financingWithCommercialData = [
    (
      <SlideContainer key="Financing-1">
        <Box>
    ...
    (
      <SlideContainer key="Financing-2">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Financing-3">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Financing-4">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Financing-5">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
    ...
    (
      <SlideContainer key="Financing-6">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="5" nextStep="7" />
      </SlideContainer>
    ),
    (
      <SlideContainer key="Financing-7">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="6" nextStep="8" />
      </SlideContainer>
    ),
    (
      <SlideContainer key="Financing-8">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
          ...
          <Text textStyle="Body1" fontWeight="500" my={4}>
            Coral seeks out non-recourse loans. These loans typically have something calls a &ldquo;bad
            boy carve-out.&rdquo; This is common in commercial real estate and defines exceptions that
            result in full-recourse liability when bad-boy behaviors exist (e.g., fraud, gross
            negligence or criminal acts). Coral is on the hook for this &ldquo;bad-boy carve-out.&rdquo;
          </Text>
        </Box>
        <BtnsWrapper route={route} prevStep="7" nextStep="9" />
      </SlideContainer>
    ),
    (
      <SlideContainer key="Financing-9">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="8" nextStep="10" />
      </SlideContainer>
    ),
    (
      <SlideContainer key="Financing-10">
        <Box>
          <Flex justifyContent="space-between" alignItems="center">
            <CloseBtn backUrl={backUrl} />
        ...
        <BtnsWrapper route={route} prevStep="9" nextStep="back-to-property" />
      </SlideContainer>
    )
  ];

  const financingEndData = (
    <Box pb={40}>
