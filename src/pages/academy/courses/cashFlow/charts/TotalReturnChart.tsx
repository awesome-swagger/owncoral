...
const Chart = ({ width, height, margin = defaultMargin, animate = true }: PieProps) => {
  ...
  const pieColor1 = useColorModeValue(colors.teal[700], colors.teal[400]);
  const pieColor2 = useColorModeValue(colors.green[200], colors.green[100]);
  const pieColor3 = useColorModeValue(colors.orange[300], colors.orange[200]);
