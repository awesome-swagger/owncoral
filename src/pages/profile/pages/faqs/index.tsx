    ...
    <Box>
      ...
      <Accordion allowToggle>
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            <Text>
              To own properties through Coral, you must be a U.S. resident (or foreign resident with
              a U.S. tax ID), over the age of 18, who qualifies as an <b>accredited investor</b>.
            </Text>
            <br />
            <Text>
        ...
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            <Text>
              ...
              fractional ownership of the property through a property-specific LLC. Coral obtains a
              bank mortgage (typically ~65% of the purchase price) to provide leverage.
            </Text>
            <br />
            ...
            <Text>
              ...
              the property is well managed. Coral helps owners &ldquo;realize appreciation&rdquo;
              when the property rises in value. When you want to sell your allocation, we help with
              that too.
            </Text>
            <br />
        ...
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            ...
            <Text>
              ...
              price of the property, including closing costs (2) the budget for planned renovations
              intended to force appreciation of the property, (3) an initial reserve equal to 5% of
              the property price that is intended to help cover expenses associated with the
              principal repayment of the mortgage, and any necessary maintenance and repair of the
              property (4) an acquisition fee of 2% of the purchase price paid to Coral.
            </Text>
            <br />
        ...
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            <Text>
              Through Coral, you have (fractional) direct ownership of a property. As a result, your
              returns can be generated through both recurring income (from rentals), and potential
              capital appreciation of the properties themselves.
            </Text>
            <br />
            <Text>
              <b>Income</b>: As a fractional owner, you are entitled to your pro-rata portion of any
              operating cash flow, distributed on a monthly basis. This distribution is paid out as
              &ldquo;return of capital&rdquo; until your initial investment is repaid.
            </Text>
            <br />
        ...
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            <Text>
              ...
              same time. As a result, Coral has a vested interest in the financial success of each
              property and has aligned interests with the other investors in the property.
            </Text>
          </AccordionPanel>
        </AccordionItem>
        ...
        <AccordionItem layerStyle="accordionColor">
          ...
          <AccordionPanel pt={4}>
            ...
            <br />
            <Text>
              Coral investments are intended to be long-term investments, but in the event that you
              want to sell your shares, Coral will help find a buyer through our platform. In the
              event that we cannot find you a buyer, you can exercise your right to liquidity at the
              fifth anniversary. At each fifth anniversary, if any owner wants to sell and there is
              no willing buyer, the property will be listed for sale and the proceeds of the sale
              will be distributed to each owner pro rata.
            </Text>
          </AccordionPanel>
        </AccordionItem>
